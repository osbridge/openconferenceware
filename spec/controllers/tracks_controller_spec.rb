...
=begin
  ...
  describe "responding to GET index" do
    ...
    it "should expose all tracks as @tracks" do
      Track.should_receive(:find).with(:all).and_return([mock_track])
      get :index
    ...
    describe "with mime type of xml" do
      ...
      it "should render all tracks as xml" do
        request.env["HTTP_ACCEPT"] = "application/xml"
        Track.should_receive(:find).with(:all).and_return(tracks = mock("Array of Tracks"))
  ...
  describe "responding to POST create" do
    ...
    describe "with valid params" do
      ...
      it "should redirect to the created track" do
